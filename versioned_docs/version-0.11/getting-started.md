...
```
Gradle : compile "org.drasyl:drasyl-node:0.11.0" // build.gradle 
   Ivy : <dependency org="org.drasyl" name="drasyl-node" rev="0.11.0" conf="build" /> // ivy.xml
   SBT : libraryDependencies += "org.drasyl" % "drasyl-node" % "0.11.0" // build.sbt
```
