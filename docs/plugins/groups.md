...
```
Gradle : compile "org.drasyl:drasyl-plugin-groups-client:0.10.0-SNAPSHOT" // build.gradle 
...
Other dependency managers:
```
Gradle : compile "org.drasyl:drasyl-plugin-groups-manager:0.10.0-SNAPSHOT" // build.gradle 
